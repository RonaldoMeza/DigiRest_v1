        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
            ...
            <form wire:submit.prevent='save'>
                ...
                <div>
                    ...
                    @error('email')
                        <p class="hidden text-xs text-red-600 mt-2" id="email-error">Correo electrónico inválido.</p>
                    @enderror
                </div>
                <!-- End Form Group -->
                ...
                <div>
                    ...
                    <p class="hidden text-xs text-red-600 mt-2" id="password-error">Contraseña inválido</p>
                </div>
                <!-- End Form Group -->
