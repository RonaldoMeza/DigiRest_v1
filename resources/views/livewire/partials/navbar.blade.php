<header class="flex z-50 sticky top-0 flex-wrap md:justify-start md:flex-nowrap w-full bg-black text-sm nav-link-prop py-3 md:py-0 dark:bg-gray-800 shadow-md">
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8 py-4" aria-label="Global">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="md:hidden">
                <button type="button" class="hs-collapse-toggle flex justify-center items-center w-9 h-9 text-sm font-semibold rounded-lg border border-gray-200 text-white hover:bg-digirestDark disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-gray-70bg-gray-700" data-hs-collapse-toggle data-hs-collapse="#navbar-collapse" aria-controls="navbar-collapse-with-animation" aria-label="Toggle navigation">
        ...
        <div id="navbar-collapse" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
            ...
            <div class="select-none py-4 flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-black md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
                ...
                @auth
                    <div class="hs-dropdown" data-hs-dropdown="{...}" data-hs-dropdown-placement="bottom-end">
                        <button type="button" class="hs-dropdown-toggle flex items-center w-full text-gray-500 hover:text-gray-400 font-medium dark:text-gray-400 dark:hover:text-gray-500" data-hs-dropdown-toggle>
                            {{ auth()->user()->name }}
