<header class="flex z-50 sticky top-0 flex-wrap md:justify-start md:flex-nowrap w-full bg-black text-sm nav-link-prop py-3 md:py-0 dark:bg-gray-800 shadow-md">
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
        ...
        <div class="flex items-center justify-between">
            <a class="nav-logo" href="/" aria-label="Brand">Digi<span class="span1-logo">Rest</span></a>
            <div class="md:hidden">
        ...
        <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
            ...
            <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-black md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
                ...
                {{-- <a class=" nav-link-prop " href="/delivery">
                Pedir delivery
                </a> --}}
                ...
                <a class="nav-link-prop flex items-center " href="/cart">
                    ...
                    <span class="mr-1">Carrito</span> <span class="py-0.5 px-1.5 rounded-full text-xs  bg-digirest border border-digirestDark text-black">4</span>
                </a>
                ...
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500bg-gray-70text-gray-300" href="#">
                    My Orders
                </a>
